                ...
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                    <div class="card bg-dark text-white" style="border-radius: 1rem;">
                        <div class="card-body p-5 text-center">
                            <form action="/admin/panel/users/edit/{{$user -> user_id}}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="mb-md-5 mt-md-5 ">
                                    ...
                                    <div class="form-outline form-white mb-4">
                                        <input type="text" id="first_name" class="form-control form-control-lg" name="first_name" value="{{$user -> first_name}}"/>
                                        <label class="form-label" for="first_name">First Name</label>
                                    </div>

                                    <div class="form-outline form-white mb-2">
                                        <input type="text" id="last_name" class="form-control form-control-lg" name="last_name" value="{{$user -> last_name}}"/>
                                    ...
                                    <div class="form-outline form-white mb-4">
                                        <input type="text" id="mobile" class="form-control form-control-lg" name="mobile" value="{{$user -> mobile}}"/>
                                        <label class="form-label" for="mobile">Mobile Number</label>
                                    </div>

                                    <div class="form-outline form-white mb-4">
                                        <input type="text" id="province" class="form-control form-control-lg" name="province" value="{{$user -> province}}"/>
